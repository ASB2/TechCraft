...
public class ContainerSelectiveItemExtractor extends Container {

    public ContainerSelectiveItemExtractor(InventoryPlayer par1InventoryPlayer, TileSelectiveItemExtractor tileEntity) {
