...
public class GUI {
    ...
    public static final String GUI_DEFAULT = "/mods/TechCraft/textures/gui/guiblank.png";
    ...
    public static final String TC_GENORATOR = "/mods/TechCraft/textures/gui/GuiGenorator.png";
