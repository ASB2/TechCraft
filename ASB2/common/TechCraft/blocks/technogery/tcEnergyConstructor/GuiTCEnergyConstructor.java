...
public class GuiTCEnergyConstructor extends GuiContainer {
    ...
    protected void drawGuiContainerBackgroundLayer(float opacity, int x, int y) {
        ...
        drawTexturedModalRect(posX + 102 - 1, posY + 16 - 1, 176, 32, 18, 18);
        drawTexturedModalRect(posX + 78 - 1, posY + 38 - 1, 176, 32, 18, 18);
        
        drawTexturedModalRect(posX + 60 - 1, posY + 57 - 1, 176, 32, 18, 18);
        drawTexturedModalRect(posX + 78 - 1, posY + 57 - 1, 176, 32, 18, 18);
        drawTexturedModalRect(posX + 96 - 1, posY + 57 - 1, 176, 32, 18, 18);
        //This renders the energy gauge. Lower the last number to increase the energy displayed

        int i1 = tileEntity.getPowerScaled(71);

        drawTexturedModalRect(posX + 21, posY + 7, 176, 51, 18, 71);
        drawTexturedModalRect(posX + 21, posY + 7 + 71 - i1, 194, 51, 18, i1);
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float gameTicks) {
        ...
        if(isPointInRegion(21, 7, 18, 71, mouseX, mouseY)) {
