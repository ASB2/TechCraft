...
public class GuiWirelessEnergyManager extends GuiContainer {

    private TileWirelessEnergyManager tileEntity;

    public final int xSizeOfTexture = 176;
    public final int ySizeOfTexture = 166;

    public GuiWirelessEnergyManager(InventoryPlayer inventory, TileWirelessEnergyManager tileEntity) {
        super(new ContainerWirelessEnergyManager(inventory, tileEntity));
    ...
    protected void drawGuiContainerBackgroundLayer(float opacity, int x, int y) {
        ...
        drawTexturedModalRect(posX + 61 - 1, posY + 11 - 1, 176, 32, 18, 18);
        drawTexturedModalRect(posX + 61 - 1, posY + 29 - 1, 176, 32, 18, 18);
        drawTexturedModalRect(posX + 61 - 1, posY + 47 - 1, 176, 32, 18, 18);
        drawTexturedModalRect(posX + 61 - 1, posY + 65 - 1, 176, 32, 18, 18);
        
        drawTexturedModalRect(posX + 101 - 1, posY + 11 - 1, 176, 32, 18, 18); 
        drawTexturedModalRect(posX + 101 - 1, posY + 29 - 1, 176, 32, 18, 18); 
        drawTexturedModalRect(posX + 101 - 1, posY + 47 - 1, 176, 32, 18, 18);         
        drawTexturedModalRect(posX + 101 - 1, posY + 65 - 1, 176, 32, 18, 18);    
        
        int i1 = tileEntity.getPowerScaled(71);

        drawTexturedModalRect(posX + 80, posY + 9, 176, 51, 18, 71);
        drawTexturedModalRect(posX + 80, posY + 9 + 71 - i1, 194, 51, 18, i1);
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float gameTicks) {
        ...
        if(isPointInRegion(80, 9, 18, 71, mouseX, mouseY)) {
