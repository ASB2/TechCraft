...
public class TileEnergySender extends TechCraftTile implements IPowerMisc {
    ...
    public void updateEntity() {
        ...
        if(!worldObj.isBlockIndirectlyGettingPowered(xCoord, yCoord, zCoord)) {
            ...
            TileEntity tileToAffect = UtilDirection.translateDirectionToTile(this ,worldObj, this.getOrientation());

            if(tileToAffect != null) {

                if(tileToAffect instanceof IPowerMisc  && ((IPowerMisc)tileToAffect).getPowerProvider() != null) {

                    if(this.getPowerProvider().requestingPower()) {

                        UtilPower.transferPower(((IPowerMisc)tileToAffect), this);
                    }
                }
            }
