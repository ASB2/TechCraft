...
public class TileRendererSelectiveItemExtractor extends TileEntitySpecialRenderer {

    private ModelConduitInterface model;

    public TileRendererSelectiveItemExtractor() {
    ...
    public void renderTileEntityAt(TileEntity par1TileEntity, double x, double y, double z, float frames){
        ...
        if(par1TileEntity instanceof TileSelectiveItemExtractor) {

            this.renderAModelAt((TileSelectiveItemExtractor)par1TileEntity, x, y, z, frames);
        }
    } 

    public void renderAModelAt(TileSelectiveItemExtractor tile, double x, double y, double z, float frames) {
