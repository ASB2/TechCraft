...
public class ModelPowerConduit extends ModelBase {
    ...
    public ModelPowerConduit() {
        ...
        RingTop.addBox(-3F, 0F, -3F, 6, 1, 6);
        RingTop.setRotationPoint(0F, 13F, 0F);
        RingTop.setTextureSize(128, 64);
        RingTop.mirror = true;
        setRotation(RingTop, 0F, 0F, 0F);
        RingBottom = new ModelRenderer(this, 0, 41);
        RingBottom.addBox(-3F, 0F, -3F, 6, 1, 6);
        RingBottom.setRotationPoint(0F, 18F, 0F);
        RingBottom.setTextureSize(128, 64);
        RingBottom.mirror = true;
        setRotation(RingBottom, 0F, 0F, 0F);
        RingFront = new ModelRenderer(this, 0, 49);
        RingFront.addBox(-3F, -3F, 0F, 6, 6, 1);
        RingFront.setRotationPoint(0F, 16F, -3F);
        RingFront.setTextureSize(128, 64);
        RingFront.mirror = true;
        setRotation(RingFront, 0F, 0F, 0F);
        RingBack = new ModelRenderer(this, 0, 49);
        RingBack.addBox(-3F, -3F, 0F, 6, 6, 1);
        RingBack.setRotationPoint(0F, 16F, 2F);
        RingBack.setTextureSize(128, 64);
        RingBack.mirror = true;
        setRotation(RingBack, 0F, 0F, 0F);
        RingLeft = new ModelRenderer(this, 16, 52);
        RingLeft.addBox(0F, -3F, -3F, 1, 6, 6);
        RingLeft.setRotationPoint(2F, 16F, 0F);
        RingLeft.setTextureSize(128, 64);
        RingLeft.mirror = true;
        setRotation(RingLeft, 0F, 0F, 0F);
        RingRight = new ModelRenderer(this, 16, 52);
        RingRight.addBox(0F, -3F, -3F, 1, 6, 6);
        RingRight.setRotationPoint(-3F, 16F, 0F);
