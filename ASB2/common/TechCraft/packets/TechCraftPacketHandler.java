...
import TechCraft.packets.TechCraftPacketBase.ProtocolException;
...
public class TechCraftPacketHandler implements IPacketHandler {
    ...
    public void onPacketData(INetworkManager manager, Packet250CustomPayload packet, Player player) {
        ...
        try {
            ...
            TechCraftPacketBase demoPacket = TechCraftPacketBase.constructPacket(packetId);
            demoPacket.read(in);
